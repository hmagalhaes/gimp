...
(script-fu-register "script-fu-hmagalhaes-layers-arrange-vert"
	"<Image>/Image/Web Sprites/Organizar layers verticalmente"
    "Organiza os layers verticalmente, um sobre o outro, e então redimensiona a imagem para caber os layers."
