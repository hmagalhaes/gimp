...
(script-fu-register "script-fu-hmagalhaes-layers-arrange-hor"
	"<Image>/Image/Web Sprites/Organizar layers horizontalmente"
    "Organiza os layers horizontalmente, lado a lado, e então redimensiona a imagem para caber os layers."
